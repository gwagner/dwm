...
X11INC = /usr/inclue/X11/
X11LIB = /usr/inclue/X11/
...
LIBS = -L${X11LIB} -lX11 ${XINERAMALIBS} ${FREETYPELIBS}  ${XRENDER} ${MPDCLIENT} ${XEXTLIB} ${XCBLIBS} ${KVMLIB} ${PANGOLIB} ${YAJLLIBS} -lXext -lX11-xcb -lxcb -lxcb-res
